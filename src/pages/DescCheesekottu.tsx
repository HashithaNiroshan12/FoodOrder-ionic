...
const DescCheesekottu: React.FC = () => {
 ...
 async function submit(e:any){
  ...
  db.collection('cart').doc("#CK200").set({          //.doc("basmathi rice").
    type:type,   
    title:'CHEESE KOTTU',
    price:'350.00',
    url:'../../assets/images/kottu/cheesekottu.jpg' ,
    qty:qty,
    total:350.00*qty*type,
    time:time,
    date:date
  })
  db.collection('order').doc("#CK200").set({          //.doc("basmathi rice").
  type:type,   
  title:'CHEESE KOTTU',
  price:'350.00',
  url:'../../assets/images/kottu/cheesekottu.jpg' ,
  ...
  useEffect(() => {
    const ref = db.collection('descCheesekottu');
...
export default DescCheesekottu;
